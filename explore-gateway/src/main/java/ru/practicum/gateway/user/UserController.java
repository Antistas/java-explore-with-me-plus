...
public class UserController {
    ...
    public ResponseEntity<Object> getUsersAdmin(
        ...
        log.info("Gateway: GET /admin/users | ids={}, from={}, size={}", ids, from, size);
