package ru.practicum.gateway.ewm.event.mapper;

import ru.practicum.gateway.ewm.category.mapper.CategoryMapper;
...
import ru.practicum.gateway.ewm.event.model.Location;
import ru.practicum.gateway.ewm.user.mapper.UserMapper;
...
public class EventMapper {
    ...
    public static EventFullDto toEventFullDto(Event event) {
        ...
        return EventFullDto.builder()
                ...
                .confirmedRequests(0L)  // Заполняется отдельно
